...
with open('message.txt', 'r', encoding='utf-8') as file_message:
    print(file_message.read(4))

with open('message.txt', 'r', encoding='utf-8') as file_message:
    print(file_message.readline(), end='')
    print(file_message.readline(), end='')

with open('message.txt', 'r', encoding='utf-8') as file_message:
    print(file_message.readlines(), end='') # ['Hello\n', 'Привет!\n']

with open('message.txt', 'r', encoding='utf-8') as file_message:
    print(next(file_message), end='')

os.mkdir('messages')
with open('messages/message.txt', 'a') as file_message:
    file_message.write('Hello\n')
