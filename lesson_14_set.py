...
"""
1. Написать функцию get_unique_values, принимающую список чисел и возвращающую
список уникальных чисел из принимаемого списка.
2. Написать функцию get_inner_table, принимающую два кортежа и возвращающую
кортеж чисел, которые присутствуют в обоих принимаемых кортежах.
print(get_inner_table((1, 2, 3, 5), (3, 5, 7, 8))) # (3, 5)

# def get_inner_table(t1,t2):
